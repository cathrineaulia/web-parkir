                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">MAX COST PER DAY</th>
                    </tr>
                  </thead>
                   @foreach ($datas as $nmr => $data)
                    <tr>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{ $data->jenis}}</p>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{ $data->perjam_pertama}}</p>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{ $data->perjam_berikutnya}}</p>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{ $data->max_perhari}}</p>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
